...
struct Invoke<false /* pmo */, 0 /* is_base_of */> {
    ...
    inline static constexpr auto invoke(R T::*pmo, Arg&& arg) TF_RETURN(lib::forward<Arg>(arg).*pmo)
};

template <>
struct Invoke<false /* pmo */, 1 /* is_reference_wrapper */> {
    template <typename R, typename T, typename Arg>
    inline static constexpr auto invoke(R T::*pmo, Arg&& arg) TF_RETURN(lib::forward<Arg>(arg).get().*pmo)
};
...
template <typename R, typename T, typename Arg, typename... Args>
inline constexpr auto invoke(R T::*f, Arg&& arg, Args&&... args) TF_RETURN(
        Invoke<std::is_function<R>::value,
               (std::is_base_of<T, lib::decay_t<Arg>>::value
                        ? 0
                        : is_reference_wrapper<lib::decay_t<Arg>>::value ? 1 : 2)>::invoke(f, lib::forward<Arg>(arg),
...
#pragma warning(disable : 4100)
        ...
        inline constexpr auto invoke(F&& f, Args&&... args) TF_RETURN(lib::forward<F>(f)(lib::forward<Args>(args)...))
#ifdef _MSC_VER
#pragma warning(pop)
#endif
}  // namespace detail
...
inline constexpr auto invoke(F&& f, Args&&... args)
        TF_RETURN(detail::invoke(lib::forward<F>(f), lib::forward<Args>(args)...))
...
#else
template <typename T>
struct is_trivially_copy_constructible : bool_constant<std::is_copy_constructible<T>::value&& __has_trivial_copy(T)> {};
...
#ifdef _MSC_VER
            AUTO_REFREF_RETURN(recursive_union::get_alt(lib::forward<V>(v).data_, in_place_index_t<I>{}))
#else
            AUTO_REFREF_RETURN(recursive_union::get_alt(base_data(lib::forward<V>(v)), in_place_index_t<I>{}))
#endif
};
...
struct base {
    ...
    using dispatch_result_t =
            decltype(lib::invoke(std::declval<Visitor>(), access::base::get_alt<0>(std::declval<Vs>())...));
    ...
    struct dispatcher<false, R, ITs...> {
        ...
        TF_ALWAYS_INLINE static constexpr R dispatch(F&&, typename ITs::type&&..., Vs&&...) {
            TF_BUILTIN_UNREACHABLE;
        }
        ...
        template <std::size_t B, typename F, typename... Vs>
        TF_ALWAYS_INLINE static constexpr R dispatch_at(std::size_t, F&&, Vs&&...) {
            TF_BUILTIN_UNREACHABLE;
        }
    };
    ...
    struct dispatcher<true, R, ITs...> {
        ...
        TF_ALWAYS_INLINE static constexpr R dispatch(F&& f, typename ITs::type&&... visited_vs) {
            using Expected = R;
            using Actual = decltype(
                    lib::invoke(lib::forward<F>(f),
                                access::base::get_alt<ITs::value>(lib::forward<typename ITs::type>(visited_vs))...));
        ...
        TF_ALWAYS_INLINE static constexpr R dispatch(F&& f, typename ITs::type&&... visited_vs, V&& v, Vs&&... vs) {
#define TF_DISPATCH(I)                                                                                   \
    dispatcher<(I < lib::decay_t<V>::size()), R, ITs..., lib::indexed_type<I, V>>::template dispatch<0>( \
            lib::forward<F>(f), lib::forward<typename ITs::type>(visited_vs)..., lib::forward<V>(v),     \
            lib::forward<Vs>(vs)...)
...
#define TF_DEFAULT(I)                                                                                \
    dispatcher<(I < lib::decay_t<V>::size()), R, ITs...>::template dispatch<I>(                      \
            ...
            switch (v.index()) {
                case B + 0:
                    return TF_DISPATCH(B + 0);
                case B + 1:
                    return TF_DISPATCH(B + 1);
                case B + 2:
                    return TF_DISPATCH(B + 2);
                case B + 3:
                    return TF_DISPATCH(B + 3);
                case B + 4:
                    return TF_DISPATCH(B + 4);
                case B + 5:
                    return TF_DISPATCH(B + 5);
                case B + 6:
                    return TF_DISPATCH(B + 6);
                case B + 7:
                    return TF_DISPATCH(B + 7);
                case B + 8:
                    return TF_DISPATCH(B + 8);
                case B + 9:
                    return TF_DISPATCH(B + 9);
                case B + 10:
                    return TF_DISPATCH(B + 10);
                case B + 11:
                    return TF_DISPATCH(B + 11);
                case B + 12:
                    return TF_DISPATCH(B + 12);
                case B + 13:
                    return TF_DISPATCH(B + 13);
                case B + 14:
                    return TF_DISPATCH(B + 14);
                case B + 15:
                    return TF_DISPATCH(B + 15);
                case B + 16:
                    return TF_DISPATCH(B + 16);
                case B + 17:
                    return TF_DISPATCH(B + 17);
                case B + 18:
                    return TF_DISPATCH(B + 18);
                case B + 19:
                    return TF_DISPATCH(B + 19);
                case B + 20:
                    return TF_DISPATCH(B + 20);
                case B + 21:
                    return TF_DISPATCH(B + 21);
                case B + 22:
                    return TF_DISPATCH(B + 22);
                case B + 23:
                    return TF_DISPATCH(B + 23);
                case B + 24:
                    return TF_DISPATCH(B + 24);
                case B + 25:
                    return TF_DISPATCH(B + 25);
                case B + 26:
                    return TF_DISPATCH(B + 26);
                case B + 27:
                    return TF_DISPATCH(B + 27);
                case B + 28:
                    return TF_DISPATCH(B + 28);
                case B + 29:
                    return TF_DISPATCH(B + 29);
                case B + 30:
                    return TF_DISPATCH(B + 30);
                case B + 31:
                    return TF_DISPATCH(B + 31);
                default:
                    return TF_DEFAULT(B + 32);
            }
...
#undef TF_DISPATCH
        ...
        template <std::size_t I, typename F, typename... Vs>
        TF_ALWAYS_INLINE static constexpr R dispatch_case(F&& f, Vs&&... vs) {
            using Expected = R;
            using Actual = decltype(lib::invoke(lib::forward<F>(f), access::base::get_alt<I>(lib::forward<Vs>(vs))...));
            return visit_return_type_check<Expected, Actual>::invoke(lib::forward<F>(f),
                                                                     access::base::get_alt<I>(lib::forward<Vs>(vs))...);
        }

        template <std::size_t B, typename F, typename V, typename... Vs>
        TF_ALWAYS_INLINE static constexpr R dispatch_at(std::size_t index, F&& f, V&& v, Vs&&... vs) {
            static_assert(lib::all<(lib::decay_t<V>::size() == lib::decay_t<Vs>::size())...>::value,
                          "all of the variants must be the same size.");
#define TF_DISPATCH_AT(I)                                                                                           \
    dispatcher<(I < lib::decay_t<V>::size()), R>::template dispatch_case<I>(lib::forward<F>(f), lib::forward<V>(v), \
                                                                            lib::forward<Vs>(vs)...)

#define TF_DEFAULT(I)                                                                                \
    dispatcher<(I < lib::decay_t<V>::size()), R>::template dispatch_at<I>(index, lib::forward<F>(f), \
                                                                          lib::forward<V>(v), lib::forward<Vs>(vs)...)

            switch (index) {
                case B + 0:
                    return TF_DISPATCH_AT(B + 0);
                case B + 1:
                    return TF_DISPATCH_AT(B + 1);
                case B + 2:
                    return TF_DISPATCH_AT(B + 2);
                case B + 3:
                    return TF_DISPATCH_AT(B + 3);
                case B + 4:
                    return TF_DISPATCH_AT(B + 4);
                case B + 5:
                    return TF_DISPATCH_AT(B + 5);
                case B + 6:
                    return TF_DISPATCH_AT(B + 6);
                case B + 7:
                    return TF_DISPATCH_AT(B + 7);
                case B + 8:
                    return TF_DISPATCH_AT(B + 8);
                case B + 9:
                    return TF_DISPATCH_AT(B + 9);
                case B + 10:
                    return TF_DISPATCH_AT(B + 10);
                case B + 11:
                    return TF_DISPATCH_AT(B + 11);
                case B + 12:
                    return TF_DISPATCH_AT(B + 12);
                case B + 13:
                    return TF_DISPATCH_AT(B + 13);
                case B + 14:
                    return TF_DISPATCH_AT(B + 14);
                case B + 15:
                    return TF_DISPATCH_AT(B + 15);
                case B + 16:
                    return TF_DISPATCH_AT(B + 16);
                case B + 17:
                    return TF_DISPATCH_AT(B + 17);
                case B + 18:
                    return TF_DISPATCH_AT(B + 18);
                case B + 19:
                    return TF_DISPATCH_AT(B + 19);
                case B + 20:
                    return TF_DISPATCH_AT(B + 20);
                case B + 21:
                    return TF_DISPATCH_AT(B + 21);
                case B + 22:
                    return TF_DISPATCH_AT(B + 22);
                case B + 23:
                    return TF_DISPATCH_AT(B + 23);
                case B + 24:
                    return TF_DISPATCH_AT(B + 24);
                case B + 25:
                    return TF_DISPATCH_AT(B + 25);
                case B + 26:
                    return TF_DISPATCH_AT(B + 26);
                case B + 27:
                    return TF_DISPATCH_AT(B + 27);
                case B + 28:
                    return TF_DISPATCH_AT(B + 28);
                case B + 29:
                    return TF_DISPATCH_AT(B + 29);
                case B + 30:
                    return TF_DISPATCH_AT(B + 30);
                case B + 31:
                    return TF_DISPATCH_AT(B + 31);
                default:
                    return TF_DEFAULT(B + 32);
            }
...
#undef TF_DISPATCH_AT
    ...
    inline static constexpr const lib::remove_all_extents_t<T>& at(const lib::array<T, N>& elems, std::size_t i,
                                                                   Is... is) noexcept {
        return at(elems[i], is...);
    }

    template <typename F, typename... Fs>
    inline static constexpr lib::array<lib::decay_t<F>, sizeof...(Fs) + 1> make_farray(F&& f, Fs&&... fs) {
    ...
    struct make_fmatrix_impl {
        ...
        inline static constexpr dispatch_result_t<F, Vs...> dispatch(F&& f, Vs&&... vs) {
            ...
            using Actual =
                    decltype(lib::invoke(lib::forward<F>(f), access::base::get_alt<Is>(lib::forward<Vs>(vs))...));
            return visit_return_type_check<Expected, Actual>::invoke(
    ...
    inline static constexpr auto make_fmatrix() {
        return make_fmatrix_impl<F, Vs...>::impl(lib::index_sequence<>{},
    ...
    struct make_fdiagonal_impl {
        ...
        template <std::size_t... Is>
        inline static constexpr AUTO impl(lib::index_sequence<Is...>) AUTO_RETURN(make_farray(&dispatch<Is>...))
    };

    template <typename F, typename V, typename... Vs>
    inline static constexpr auto make_fdiagonal()
            -> decltype(make_fdiagonal_impl<F, V, Vs...>::impl(lib::make_index_sequence<lib::decay_t<V>::size()>{})) {
        static_assert(lib::all<(lib::decay_t<V>::size() == lib::decay_t<Vs>::size())...>::value,
                      "all of the variants must be the same size.");
        return make_fdiagonal_impl<F, V, Vs...>::impl(lib::make_index_sequence<lib::decay_t<V>::size()>{});
    }
#endif
};

#if !defined(TF_VARIANT_SWITCH_VISIT) && (!defined(_MSC_VER) || _MSC_VER >= 1910)
template <typename F, typename... Vs>
    ...
    inline static constexpr DECLTYPE_AUTO visit_alt(Visitor&& visitor, Vs&&... vs)
            ...
            DECLTYPE_AUTO_RETURN(
                    base::dispatcher<true,
                            ...
                            template dispatch<0>(lib::forward<Visitor>(visitor), as_base(lib::forward<Vs>(vs))...))
#elif !defined(_MSC_VER) || _MSC_VER >= 1910
            DECLTYPE_AUTO_RETURN(base::at(fmatrix<Visitor&&, decltype(as_base(lib::forward<Vs>(vs)))...>::value,
                                          vs.index()...)(lib::forward<Visitor>(visitor),
                                                         as_base(lib::forward<Vs>(vs))...))
#else
            DECLTYPE_AUTO_RETURN(base::at(base::make_fmatrix<Visitor&&, decltype(as_base(lib::forward<Vs>(vs)))...>(),
                                          vs.index()...)(lib::forward<Visitor>(visitor),
                                                         as_base(lib::forward<Vs>(vs))...))
#endif
...
#else
                    DECLTYPE_AUTO_RETURN(
                            base::at(base::make_fdiagonal<Visitor&&, decltype(as_base(lib::forward<Vs>(vs)))...>(),
                                     index)(lib::forward<Visitor>(visitor), as_base(lib::forward<Vs>(vs))...))
#endif
};
...
private:
    ...
    struct visit_exhaustiveness_check {
        ...
        inline static constexpr DECLTYPE_AUTO invoke(Visitor&& visitor, Values&&... values)
                DECLTYPE_AUTO_RETURN(lib::invoke(lib::forward<Visitor>(visitor), lib::forward<Values>(values)...))
    };
    ...
    struct value_visitor {
        ...
        inline constexpr DECLTYPE_AUTO operator()(Alts&&... alts) const DECLTYPE_AUTO_RETURN(
                visit_exhaustiveness_check<Visitor, decltype((lib::forward<Alts>(alts).value))...>::invoke(
...
TF_VARIANT_RECURSIVE_UNION(Trait::TriviallyAvailable, ~recursive_union() = default;);
TF_VARIANT_RECURSIVE_UNION(Trait::Available, ~recursive_union(){});
TF_VARIANT_RECURSIVE_UNION(Trait::Unavailable, ~recursive_union() = delete;);
...
using index_t = typename std::conditional<
        ...
        typename std::conditional<sizeof...(Ts) < (std::numeric_limits<unsigned short>::max)(), unsigned short,
                                  unsigned int>::type>::type;

template <Trait DestructibleTrait, typename... Ts>
class base {
public:
    inline explicit constexpr base(valueless_t tag) noexcept : data_(tag), index_(static_cast<index_t<Ts...>>(-1)) {
    }
...
protected:
    ...
    friend inline constexpr data_t& base_data(base& b) {
        return b.data_;
    }
    friend inline constexpr const data_t& base_data(const base& b) {
        return b.data_;
    }
    friend inline constexpr data_t&& base_data(base&& b) {
...
TF_VARIANT_DESTRUCTOR(Trait::TriviallyAvailable, ~destructor() = default;
                      , inline void destroy() noexcept { this->index_ = static_cast<index_t<Ts...>>(-1); });

TF_VARIANT_DESTRUCTOR(Trait::Available, ~destructor() { destroy(); },
...
TF_VARIANT_DESTRUCTOR(Trait::Unavailable, ~destructor() = delete;, inline void destroy() noexcept = delete;);
...
TF_VARIANT_MOVE_CONSTRUCTOR(Trait::TriviallyAvailable, move_constructor(move_constructor&& that) = default;);

TF_VARIANT_MOVE_CONSTRUCTOR(Trait::Available, move_constructor(move_constructor&& that) noexcept(
...
TF_VARIANT_MOVE_CONSTRUCTOR(Trait::Unavailable, move_constructor(move_constructor&&) = delete;);
...
TF_VARIANT_COPY_CONSTRUCTOR(Trait::TriviallyAvailable, copy_constructor(const copy_constructor& that) = default;);

TF_VARIANT_COPY_CONSTRUCTOR(Trait::Available, copy_constructor(const copy_constructor& that)
                            : copy_constructor(valueless_t{}) { this->generic_construct(*this, that); });

TF_VARIANT_COPY_CONSTRUCTOR(Trait::Unavailable, copy_constructor(const copy_constructor&) = delete;);
...
TF_VARIANT_MOVE_ASSIGNMENT(Trait::TriviallyAvailable, move_assignment& operator=(move_assignment&& that) = default;);

TF_VARIANT_MOVE_ASSIGNMENT(Trait::Available, move_assignment& operator=(move_assignment&& that) noexcept(
...
TF_VARIANT_MOVE_ASSIGNMENT(Trait::Unavailable, move_assignment& operator=(move_assignment&&) = delete;);
...
TF_VARIANT_COPY_ASSIGNMENT(Trait::TriviallyAvailable,
                           copy_assignment& operator=(const copy_assignment& that) = default;);

TF_VARIANT_COPY_ASSIGNMENT(Trait::Available, copy_assignment& operator=(const copy_assignment& that) {
    this->generic_assign(that);
    return *this;
});

TF_VARIANT_COPY_ASSIGNMENT(Trait::Unavailable, copy_assignment& operator=(const copy_assignment&) = delete;);
...
private:
    ...
    inline constexpr bool move_nothrow() const {
        return this->valueless_by_exception() ||
               lib::array<bool, sizeof...(Ts)>{{std::is_nothrow_move_constructible<Ts>::value...}}[this->index()];
    }
};
...
template <typename Arg, std::size_t I, typename T, bool = std::is_arithmetic<T>::value, typename = void>
...
template <typename Arg, std::size_t I, typename T>
struct overload_leaf<Arg, I, T, true
...
class variant {
    ...
    static_assert(lib::all<!std::is_void<Ts>::value...>::value, "variant can not have a void type as an alternative.");
...
public:
    ...
    template <typename Arg, lib::enable_if_t<!std::is_same<lib::decay_t<Arg>, variant>::value, int> = 0,
              std::size_t I = detail::best_match<Arg, Ts...>::value, typename T = lib::type_pack_element_t<I, Ts...>,
...
inline constexpr AUTO_REFREF generic_get(V&& v)
        AUTO_REFREF_RETURN(generic_get_impl<I, V>(holds_alternative<I>(v) ? 0 : (throw_bad_variant_access(),
                                                                                 0))(lib::forward<V>(v)))
}  // namespace detail
...
template <std::size_t I, typename... Ts>
inline constexpr lib::add_pointer_t<const variant_alternative_t<I, variant<Ts...>>> get_if(
...
inline constexpr decltype(auto) visit(Visitor&& visitor, Vs&&... vs) {
    return (!detail::any({vs.valueless_by_exception()...}) ? (void)0 : throw_bad_variant_access()),
...
constexpr bool is_enabled() noexcept {
    using H = std::hash<K>;
    return meets_requirements<H, K>() && std::is_default_constructible<H>::value && std::is_copy_assignable<H>::value &&
...
template <typename... Ts>
struct hash<knitter::nstd::detail::enabled_type<
        knitter::nstd::variant<Ts...>,
        knitter::nstd::lib::enable_if_t<knitter::nstd::lib::all<
                knitter::nstd::detail::hash::is_enabled<knitter::nstd::lib::remove_const_t<Ts>>()...>::value>>> {
    using argument_type = knitter::nstd::variant<Ts...>;
    using result_type = std::size_t;

    inline result_type operator()(const argument_type& v) const {
        using knitter::nstd::detail::visitation::variant;
        std::size_t result =
                v.valueless_by_exception()
                        ? 299792458  // Random value chosen by the universe upon
                                     // creation
                        : variant::visit_alt(
#ifdef TF_GENERIC_LAMBDAS
                                  [](const auto& alt) {
                                      using alt_type = knitter::nstd::lib::decay_t<decltype(alt)>;
                                      using value_type =
                                              knitter::nstd::lib::remove_const_t<typename alt_type::value_type>;
...
private:
    ...
    struct hasher {
        ...
        inline std::size_t operator()(const Alt& alt) const {
            using alt_type = knitter::nstd::lib::decay_t<Alt>;
            using value_type = knitter::nstd::lib::remove_const_t<typename alt_type::value_type>;
            return hash<value_type>{}(alt.value);
        }
    };
#endif
...
template <>
struct hash<knitter::nstd::monostate> {
    using argument_type = knitter::nstd::monostate;
    using result_type = std::size_t;
