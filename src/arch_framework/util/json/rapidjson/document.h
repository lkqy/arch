...
public:
    ...
    */
    explicit GenericValue(Type type) RAPIDJSON_NOEXCEPT : data_(), flags_() {
        static const unsigned defaultFlags[7] = {kNullFlag,  kFalseFlag,       kTrueFlag,     kObjectFlag,
        ...
        if (o.size >= o.capacity) {
            if (o.capacity == 0) {
                ...
                o.members = reinterpret_cast<Member*>(
                        allocator.Realloc(o.members, oldCapacity * sizeof(Member), o.capacity * sizeof(Member)));
            }
        }
    ...
    */
    MemberIterator EraseMember(ConstMemberIterator first, ConstMemberIterator last) {
        ...
        for (MemberIterator itr = pos; itr != last; ++itr)
            itr->~Member();
        std::memmove(static_cast<void*>(&*pos), &*last, (MemberEnd() - last) * sizeof(Member));
    ...
    GenericValue& Reserve(SizeType newCapacity, Allocator& allocator) {
        ...
        if (newCapacity > data_.a.capacity) {
            data_.a.elements = (GenericValue*)allocator.Realloc(
                    data_.a.elements, data_.a.capacity * sizeof(GenericValue), newCapacity * sizeof(GenericValue));
    ...
    */
    ValueIterator Erase(ConstValueIterator first, ConstValueIterator last) {
        ...
        for (ValueIterator itr = pos; itr != last; ++itr)
            itr->~GenericValue();
        std::memmove(static_cast<void*>(pos), last, (End() - last) * sizeof(GenericValue));
...
private:
    ...
    void SetStringRaw(StringRefType s, Allocator& allocator) {
        ...
        std::memcpy(static_cast<void*>(str), s, s.length * sizeof(Ch));
        str[s.length] = '\0';
    }
