...
DEFINE_STRUCT(InstanceProfile, (int64_t)now, (int64_t)user, (int64_t)gid, (int64_t)time, (int32_t)app_id,
              (int64_t)play_count, (std::vector<int64_t>)fids)

TEST(PARSETest, TestFeatureDefinition) {
